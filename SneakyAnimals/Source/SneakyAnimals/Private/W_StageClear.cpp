...
void UW_StageClear::SetWidgetState()
{
	...
	case 1:
		...
		ClearTime->SetText(FText::FromString(FString::FromInt(gameMode->clearTime[0])));
		break;
	case 2:
		...
		ClearTime->SetText(FText::FromString(FString::FromInt(gameMode->clearTime[1])));
		break;
	case 3:
		...
		ClearTime->SetText(FText::FromString(FString::FromInt(gameMode->clearTime[2])));
		break;
	case 4:
		...
		ClearTime->SetText(FText::FromString(FString::FromInt(gameMode->clearTime[3])));
		break;
	default:
		break;
	}
